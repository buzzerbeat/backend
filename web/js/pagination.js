    ...
    $.extend($.PaginationRenderers.defaultRenderer.prototype, {
        ...
        createLink:function(page_id, current_page, appendopts){
            ...
            else
            {
                ...
                lnk.find('a').attr({'href': this.opts.link_to.replace(/__id__/,page_id), 'target':'_self'});
            }
        ...
        getLinks:function(current_page, eventHandler) {
            var begin, end,
                ...
                np = this.pc.numPages(),
                fragment = $('<ul class="'+this.pc.opts.ul_class+'"></ul>');
            ...
            fragment.wrap("<div class='pagination'></div>");
